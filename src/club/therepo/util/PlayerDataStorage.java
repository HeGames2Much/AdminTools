...
public class PlayerDataStorage {
    ...
    public PlayerDataStorage(String path){
        plugin = (AdminTools) Bukkit.getServer().getPluginManager().getPlugin(AdminTools.PLUGIN_NAME);
    ...
    public void save() {
        ...
        try {
            ...
            AdminTools.getInstance().getLogger().log(Level.INFO, "Storage file "+file.getName()+" saved.");
